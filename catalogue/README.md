...
`thumbnail-maintenance.md`, `dicom.md`) - this file only covers what's
in each top-level folder here. For running this alongside an existing
OMERO deployment (sharing one nginx/public IP), see
