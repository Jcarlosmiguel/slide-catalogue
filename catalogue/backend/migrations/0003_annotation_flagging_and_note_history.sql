...
-- 2. Lets expert-role users edit the historical David Jenkinson note
...
CREATE TABLE IF NOT EXISTS david_note_edit_history (
  history_id BIGINT AUTO_INCREMENT PRIMARY KEY,
  curation_id BIGINT NOT NULL COMMENT 'The david_jenkinson_curation.curation_id this history entry preserves a prior version of.',
  ...
  KEY idx_david_note_edit_history_curation (curation_id)
) COMMENT='Audit trail of every edit an expert makes to a david_jenkinson_curation note - preserves the prior title/text before each overwrite.';
